...
//     directus.login(email,password).then((res) => {
//       navigate('/dashboard');
//     });
//     } catch (err) {
...
//             <img aria-hidden="true" alt="user-icon" src="https://openui.fly.dev/openui/64x64.svg?text=👤" className="w-16 h-16 rounded-full bg-pink-400 p-2" />
//           </div>
...
//             type="text" 
//             placeholder="Email"
//             className="text-neutral-100 w-full p-2 border border-neutral-600 rounded focus:outline-none focus:ring focus:ring-pink-500" value={email}
